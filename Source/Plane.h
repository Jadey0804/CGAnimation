...
public:
	...
	void init(Core* core, PSOManager* psos, Shaders* shaders, TextureManager* textureManager)
	{
		...
		vertices.push_back(addVertex(Vec3(-100.0, 0, -100.0), Vec3(0, 1, 0), 0, 0));
		vertices.push_back(addVertex(Vec3(100.0, 0, -100.0), Vec3(0, 1, 0), 1, 0));
		vertices.push_back(addVertex(Vec3(-100.0, 0, 100.0), Vec3(0, 1, 0), 0, 1));
		vertices.push_back(addVertex(Vec3(100.0, 0, 100.0), Vec3(0, 1, 0), 1, 1));
